...
namespace XK.NBear.TemplateEngine
{
	...
	{
		/// <summary>
		///	This method is called at the beginning of processing of the tag.
		/// </summary>
		...
		///	Instructs manager if inner content should be sent to default output, or custom output. 
        /// If this value is set to false, all output will be sent to current writer. If set to true
		...
		/// </summary>
        /// <param name="manager">The template manager.</param>
        /// <param name="tag">The tag.</param>
		/// <param name="innerContent">
        /// If captureinnerContent was set true, then this is the output that was generated when inside of this tag.
		/// </param>
